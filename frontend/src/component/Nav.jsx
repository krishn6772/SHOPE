...
const Nav = () => {
    ...
    return (
        <div className="w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black">
            ...
            {showProfile && (
                <div className="absolute w-[220px] h-[150px] bg-[#000000d7] top-[100%] right-[4%] border-[1px] border-[#aaa9a9] rounded-[10px] z-10">
            ...
            <div className="w-[100vw] h-[90px] flex items-center justify-between px-[20px] text-[12px] fixed bottom-0 left-0 bg-[#191818] md:hidden">
                <button
                    ...
                    onClick={() => navigate("/")}
                >
                    <MdHome className="w-[28px] h-[28px] text-[white] md:hidden" />
                    Home
                </button>
                ...
                <p className="absolute w-[18px] h-[18px] flex items-center justify-center bg-white px-[5px] py-[2px] text-black font-semibold rounded-full text-[9px] top-[10px] right-[18px]">
                    {getCartCount()}
                </p>
            </div>
        </div>
